...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # رسالة تظهر للجميع تحتوي على الاشتراك والدعوة معاً
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("👥 My Invite Link", callback_data='show_invite')] # زر دعوة إضافي
    ]
    
    await update.message.reply_text(
        f"🚀 *Welcome to SOOM Project*\n\n"
        f"1️⃣ Join channel to earn **50 Points**.\n"
        f"2️⃣ Invite friends to earn **100 Points** each!\n\n"
